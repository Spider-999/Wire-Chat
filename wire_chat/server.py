...
class Server:
    ...
    def handle_client(self, client):
        while True:
            try:
                ...
                # File transfer implementation on the client side
                if message.startswith('FTP:'):
                    filename = 'output.txt'
                    ...
                    with open(filename, 'w') as file:
                        while message:
                            if not message:
                                ...
                                print(message, file=file)
                                message = client.recv(self.BYTES).split(':')[1].decode(self.FORMAT)
                elif message != '':
    ...
    def receive(self):
        ...
        while True:
            ...
            client.sendall('[SERVER] Connected.'.encode(self.FORMAT))
